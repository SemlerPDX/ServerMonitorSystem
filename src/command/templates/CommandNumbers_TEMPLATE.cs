...
namespace ServerMonitorSystem
{
    ...
    /// providing access to a method for setting a new <see cref="IConfig_Manager.Interval"/> value.
    /// <para>
    /// Dependencies: <see cref="IConfig_Manager"/>, <see cref="IConsole_Manager"/>
    /// </para>
    /// </summary>
    /// <remarks>
    /// [A command template example for creating new numbers commands in the ServerMonitorSystem app]
    /// </remarks>
    class CommandNumbers_TEMPLATE : ICommands
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommandNumbers_TEMPLATE"/> class with the specified interfaces.
        /// </summary>
        ...
        public CommandNumbers_TEMPLATE(IConfig_Manager configManager,
        ...
        public string Usage { get; } = "interval <int>";
        public string Description { get; } = "Set Alerts monitoring interval (in minutes, default 5)\n";
        public bool ConfigSetting { get; } = true; // required true for commands changing any on-file config setting

        private const string DEFAULT_PROPERTY_DESIGNATION = "Alerts monitoring interval";
        private const string DEFAULT_PROPERTY_DESCRIPTOR = "minutes";
        private const string DEFAULT_PROPERTY_CHANGED = "interval"; // must match configManager property used below (lowercase) for command line overrides

        // Set the number range default values in the appropriate number type ex. private const float ...
        private const int DEFAULT_NUMBER_MIN = 1;
        private const int DEFAULT_NUMBER_MAX = 1440;

        // Cast ConfigValue and NewValue as appropriate type referring to configManager property and an out of range default value
        private int ConfigValue { get => _configManager.Interval; set => _configManager.Interval = value; }
        private int NewValue { get; set; } = -1;
