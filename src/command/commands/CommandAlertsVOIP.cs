...
namespace ServerMonitorSystem
{
    ...
    /// providing access to a method for toggling the VOIP server Crash Alerts Monitoring system ON/OFF.
    /// <para>
    /// Dependencies: <see cref="IConfig_Manager"/>
    /// </para>
    /// </summary>
    class CommandAlertsVOIP : ICommands
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommandAlertsVOIP"/> class with the specified interface.
        /// </summary>
        /// <param name="configManager">The object that manages the configuration settings of the system.</param>
        public CommandAlertsVOIP(IConfig_Manager configManager)
        {
        ...
        private const string DEFAULT_PROPERTY_DESIGNATION = "VOIP Server Crash Alerts";
        private const string DEFAULT_PROPERTY_CHANGED = "alertsvoip";

        public string Name { get; } = "alerts voip";
        public string Usage { get; } = "alerts voip";
        public string Description { get; } = "Toggle only VOIP Server Crash Alerts monitoring system ON/OFF";
        public bool ConfigSetting { get; } = true;
        private bool ConfigValue { get => _configManager.AlertsVOIP; set => _configManager.AlertsVOIP = value; }
        #endregion
