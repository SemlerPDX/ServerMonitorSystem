...
namespace ServerMonitorSystem
{
    ...
    /// providing access to a method for toggling the VOIP Crash Alert Emails system ON/OFF.
    /// <para>
    /// Dependencies: <see cref="IConfig_Manager"/>
    /// </para>
    /// </summary>
    class CommandEmailsVOIP : ICommands
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommandEmailsVOIP"/> class with the specified interface.
        /// </summary>
        /// <param name="configManager">The object that manages the configuration settings of the system.</param>
        public CommandEmailsVOIP(IConfig_Manager configManager)
        {
