...
namespace ServerMonitorSystem
{
    ...
    /// providing access to a method for toggling the entire Alerts Monitoring system ON/OFF.
    /// <para>
    /// Dependencies: <see cref="IConfig_Manager"/>
    /// </para>
    /// </summary>
    class CommandAlerts : ICommands
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommandAlerts"/> class with the specified interface.
        /// </summary>
        /// <param name="configManager">The object that manages the configuration settings of the system.</param>
        public CommandAlerts(IConfig_Manager configManager)
        {
        ...
        // Change only these parameters to customize this boolean property toggle command
        private const string DEFAULT_PROPERTY_DESIGNATION = "ALL Server Alerts";
        private const string DEFAULT_PROPERTY_CHANGED = "alertsall";

        public string Name { get; } = "alerts";
        public string Usage { get; } = "alerts";
        public string Description { get; } = "Toggle ALL Alerts monitoring (including alert emails) ON/OFF";
        public bool ConfigSetting { get; } = true;
        private bool ConfigValue { get => _configManager.AlertsALL; set => _configManager.AlertsALL = value; }
        #endregion
