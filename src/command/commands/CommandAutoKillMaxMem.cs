...
namespace ServerMonitorSystem
{
    ...
    /// providing access to a method for setting a new <see cref="IConfig_Manager.KillMem"/> value.
    /// <para>
    /// Dependencies: <see cref="IConfig_Manager"/>, <see cref="IConsole_Manager"/>
    /// </para>
    /// </summary>
    class CommandAutoKillMaxMem : ICommands
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommandAutoKillMaxMem"/> class with the specified interfaces.
        /// </summary>
        ...
        public CommandAutoKillMaxMem(IConfig_Manager configManager,
        ...
        public string Usage { get; } = "autokill <int>";
        public string Description { get; } = "Set maximum used RAM before Auto-Kill action (in megabytes, default 11264)\n" +
                "\n         ( Memory Data Logging is independant of the above systems )\n";


        public bool ConfigSetting { get; } = true; // required true for commands changing any on-file config setting

        private const string DEFAULT_PROPERTY_DESIGNATION = "Maximum RAM use before Server Autokill";
        private const string DEFAULT_PROPERTY_DESCRIPTOR = "megabytes";
        private const string DEFAULT_PROPERTY_CHANGED = "killmem"; // must match configManager property used below (lowercase) for command line overrides
        ...
        private const float DEFAULT_NUMBER_MAX = 1440F;

        // Cast ConfigValue and NewValue as appropriate type referring to configManager property and an out of range default value
        private float ConfigValue { get => _configManager.KillMem; set => _configManager.KillMem = value; }
        ...
        {
            return args.Length == 2 && args[0].ToLower() == Name;
        }
