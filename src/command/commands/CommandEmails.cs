...
namespace ServerMonitorSystem
{
    ...
    /// providing access to a method for toggling the entire Alert Emails system ON/OFF.
    /// <para>
    /// Dependencies: <see cref="IConfig_Manager"/>
    /// </para>
    /// </summary>
    class CommandEmails : ICommands
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommandEmails"/> class with the specified interface.
        /// </summary>
        /// <param name="configManager">The object that manages the configuration settings of the system.</param>
        public CommandEmails(IConfig_Manager configManager)
        {
        ...
        private const string DEFAULT_PROPERTY_DESIGNATION = "ALL Email Alerts";
        private const string DEFAULT_PROPERTY_CHANGED = "emailsall";

        public string Name { get; } = "emails";
        public string Usage { get; } = "emails";
        public string Description { get; } = "Toggle ALL Email Alerts functions ON/OFF";
        public bool ConfigSetting { get; } = true;
        private bool ConfigValue { get => _configManager.EmailsALL; set => _configManager.EmailsALL = value; }
        #endregion
