...
namespace ServerMonitorSystem
{
    ...
    /// </para>
    /// </summary>
    class CommandInterval : ICommands
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommandInterval"/> class with the specified interfaces.
        /// </summary>
        ...
        public CommandInterval(IConfig_Manager configManager,
        ...
        public string Description { get; } = "Set Server info monitoring interval (in minutes, default 1)\n";
        ...
        private const int DEFAULT_NUMBER_MAX = 15;
