...
namespace ServerMonitorSystem
{
    ...
    /// providing access to a method for setting a new <see cref="IConfig_Manager.MinTime"/> value.
    /// <para>
    /// Dependencies: <see cref="IConfig_Manager"/>, <see cref="IConsole_Manager"/>
    /// </para>
    /// </summary>
    class CommandMinTime : ICommands
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommandMinTime"/> class with the specified interfaces.
        /// </summary>
        ...
        public CommandMinTime(IConfig_Manager configManager,
        ...
        public string Name { get; } = "mintime";
        public string Usage { get; } = "mintime <int>";
        public string Description { get; } = "Set minimum time between repetative Memory Leak Alerts (in minutes, default 60)\n";
        public bool ConfigSetting { get; } = true; // required true for commands changing any on-file config setting

        private const string DEFAULT_PROPERTY_DESIGNATION = "Minimum time between memory alerts";
        private const string DEFAULT_PROPERTY_DESCRIPTOR = "minutes";
        private const string DEFAULT_PROPERTY_CHANGED = "mintime"; // must match configManager property used below (lowercase) for command line overrides

        // Set the number range default values in the appropriate number type ex. private const float ...
        private const int DEFAULT_NUMBER_MIN = 15;
        private const int DEFAULT_NUMBER_MAX = 11000;

        // Cast ConfigValue and NewValue as appropriate type referring to configManager property and an out of range default value
        private int ConfigValue { get => _configManager.MinTime; set => _configManager.MinTime = value; }
