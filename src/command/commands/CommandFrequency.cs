...
namespace ServerMonitorSystem
{
    ...
    /// providing access to a method for setting a new <see cref="IConfig_Manager.Frequency"/> value.
    /// <para>
    /// Dependencies: <see cref="IConfig_Manager"/>, <see cref="IConsole_Manager"/>
    /// </para>
    /// </summary>
    class CommandFrequency : ICommands
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommandFrequency"/> class with the specified interfaces.
        /// </summary>
        ...
        public CommandFrequency(IConfig_Manager configManager,
        ...
        public string Usage { get; } = "frequency <int>";
        public string Description { get; } = "Set Memory Data Logging frequency (in minutes, default 1)";
        public bool ConfigSetting { get; } = true; // required true for commands changing any on-file config setting

        private const string DEFAULT_PROPERTY_DESIGNATION = "Time between Memory Data CSV log entries";
        private const string DEFAULT_PROPERTY_DESCRIPTOR = "minutes";
        private const string DEFAULT_PROPERTY_CHANGED = "frequency"; // must match configManager property used below (lowercase) for command line overrides
        ...
        private int ConfigValue { get => _configManager.Frequency; set => _configManager.Frequency = value; }
