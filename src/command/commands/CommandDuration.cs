...
namespace ServerMonitorSystem
{
    ...
    /// providing access to a method for setting a new <see cref="IConfig_Manager.Duration"/> value.
    /// <para>
    /// Dependencies: <see cref="IConfig_Manager"/>, <see cref="IConsole_Manager"/>
    /// </para>
    /// </summary>
    class CommandDuration : ICommands
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommandDuration"/> class with the specified interfaces.
        /// </summary>
        ...
        public CommandDuration(IConfig_Manager configManager,
        ...
        public string Name { get; } = "duration";
        public string Usage { get; } = "duration <int>";
        public string Description { get; } = "Set Memory Data Logging duration (in hours, 0 = endless)";
        public bool ConfigSetting { get; } = true; // required true for commands changing any on-file config setting

        private const string DEFAULT_PROPERTY_DESIGNATION = "Time to log Memory Data to CSV file for";
        private const string DEFAULT_PROPERTY_DESCRIPTOR = "hours, 0 = endless";
        private const string DEFAULT_PROPERTY_CHANGED = "duration"; // must match configManager property used below (lowercase) for command line overrides

        // Set the number range default values in the appropriate number type ex. private const float ...
        private const int DEFAULT_NUMBER_MIN = 0;
        ...
        private int ConfigValue { get => _configManager.Duration; set => _configManager.Duration = value; }
