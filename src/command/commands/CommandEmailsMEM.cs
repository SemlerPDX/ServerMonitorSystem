...
namespace ServerMonitorSystem
{
    ...
    /// providing access to a method for toggling the Memory Leak Alert Emails system ON/OFF.
    /// <para>
    /// Dependencies: <see cref="IConfig_Manager"/>
    /// </para>
    /// </summary>
    class CommandEmailsMEM : ICommands
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommandEmailsMEM"/> class with the specified interface.
        /// </summary>
        /// <param name="configManager">The object that manages the configuration settings of the system.</param>
        public CommandEmailsMEM(IConfig_Manager configManager)
        {
        ...
        private const string DEFAULT_PROPERTY_DESIGNATION = "Memory Leak Email Alerts";
        private const string DEFAULT_PROPERTY_CHANGED = "emailsmem";

        public string Name { get; } = "emails mem";
        public string Usage { get; } = "emails mem";
        public string Description { get; } = "Toggle only Memory Leak Alerts email function ON/OFF\n";
        public bool ConfigSetting { get; } = true;
        private bool ConfigValue { get => _configManager.EmailsMEM; set => _configManager.EmailsMEM = value; }
        #endregion
