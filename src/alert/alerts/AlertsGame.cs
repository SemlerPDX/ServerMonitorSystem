namespace ServerMonitorSystem
{
    ...
    /// providing access to methods for evaluating and executing game server crash alerts.
    /// <para>
    /// Dependencies: <see cref="IConfig_Manager"/>, <see cref="IAlertsMain"/>
    /// </para>
    /// </summary>
    class AlertsGame : IAlerts
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlertsGame"/> class with the specified interfaces.
        /// </summary>
        ...
        public AlertsGame(IConfig_Manager configManager,
        ...
        {
            return !_configManager.ServerOnlineGame && !_configManager.PauseAlertsGame;
        }
        ...
        public void AlertTriggered(int playerCount, bool sendEmail, bool alertFlag)
        {
            ...
            string subject = $"{_configManager.GameOfflineAlertSubject} {playerCount} {playerDesignation} {(playerCount == 1 ? "was" : "were")} online";

            string message = $"{_configManager.GameOfflineAlertMessage}<br>" +
